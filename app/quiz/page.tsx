  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground text-base mb-6">Test your knowledge with interactive quizzes</p>
      </div>

      {!quizStarted ? (
        <Card className="shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-xl">{retryMode ? "Retry Incorrect Answers" : "Create a Quiz"}</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            <div>
              <p className="text-base mb-2">Select one or more tags to create a quiz from your flashcards</p>

              <div className="flex flex-wrap gap-2 mb-3 p-3 bg-muted/30 rounded-md min-h-[50px]">
        ...
        <Card className="shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-xl">{retryMode ? "Retry Complete" : "Quiz Complete"}</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="py-2">
              ...
              <Progress value={accuracy} className="h-3 mb-6" />

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div className="bg-muted/30 p-4 rounded-md">
                  <h4 className="font-medium text-base mb-3">Performance Summary</h4>
                ...
                {Object.keys(incorrectByTag).length > 0 && (
                  <div className="bg-muted/30 p-4 rounded-md">
                    <h4 className="font-medium text-base mb-3">Areas to Review</h4>
                    <div className="space-y-2 text-base">
              ...
              {!retryMode && totalAnswered - correctAnswers > 0 && (
                <div className="bg-amber-500/10 border border-amber-500/20 p-4 rounded-lg mb-6">
                  <h4 className="font-medium flex items-center text-amber-600 dark:text-amber-400 text-base mb-2">
                  ...
                  <Button variant="outline" onClick={startRetryQuiz} className="w-full">
              ...
              <div className="space-y-4">
                <h4 className="font-medium text-base">Question Details</h4>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        {!record.isCorrect && (
                          <>
                            <p className="text-sm text-red-500 mt-2">Your answer: {record.userAnswer}</p>
                            <p className="text-sm text-green-500 mt-1">Correct answer: {record.correctAnswer}</p>
                          </>
                        )}
                      </div>
                    </div>
          ...
          <CardFooter className="flex justify-between pt-4">
            ...
            <Button onClick={() => router.push("/flashcards")}>Review Flashcards</Button>
          </CardFooter>
        </Card>
      ) : (
        <div className="max-w-2xl mx-auto">
          ...
          <Progress value={(currentIndex / quizQuestions.length) * 100} className="h-2 mb-6" />

          {currentQuestion ? (
            <Card
              className={`mb-6 shadow-sm transition-all duration-300 ${
                answerSubmitted
            ...
            >
              <CardContent className="p-6">
                <div>
                  <h3 className="text-2xl font-medium mb-6 text-center">{currentQuestion.flashcard.front}</h3>

                  {/* Add a divider between question and answers */}
                    ...
                    {currentQuestion.options.map((option, index) => (
                      ...
                      >
                        <div className="flex items-center">
                          ...
                          <div className="text-base" dangerouslySetInnerHTML={{ __html: option }} />
                        </div>
                      </button>
                    ))}
                  </div>
                ...
                {answerSubmitted ? (
                  ...
                  >
                    ...
                    {currentIndex < quizQuestions.length - 1 && (
                      <div className="text-sm text-muted-foreground mt-4 animate-pulse flex items-center justify-center">
